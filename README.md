...
[![Download Latest Release](https://img.shields.io/github/v/release/SteffanPoulsen/SSColorAttribute)](https://github.com/SteffanPoulsen/SSColorAttribute/releases/latest)
...
1. Download the latest version of the addon as a `.zip` file from the [Releases page](https://github.com/SteffanPoulsen/SSColorAttribute/releases).
...
You are free to use, modify, and distribute this addon, as long as any derivative works are also licensed under the GPL. For more details, see the [LICENSE](LICENSE) file.

---

## Credits

Created by [Steffan Poulsen](https://github.com/SteffanPoulsen) & [ChatGPT](https://chatgpt.com) (not necessarily in that order).
